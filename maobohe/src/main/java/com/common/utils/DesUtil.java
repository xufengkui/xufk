...
public class DesUtil {
    ...
    public String[] getKey(){
		...
		try {
			inputstream = this.getClass().getResourceAsStream("keys.propertites");
			properties.load(inputstream);
			keys[0] = properties.getProperty("key1");
			keys[1] = properties.getProperty("key2");
			keys[2] = properties.getProperty("key3");
		} catch (Exception e) {
			e.printStackTrace();
		}finally{
			if (inputstream != null)
     ...
     *  DES加密
      ...
      * Description: TODO
      * Param @param data
      * Param @param firstKey
      * Param @param secondKey
      * Param @param thirdKey
      * Param @return
      * Return String
     */
